...
class ExtractFeatureHook(Hook):
    ...
    #         features, features_crop, img_ids = self.extract_features(
    ...
    #         runner.model.module.roi_head.bbox_head.loss_reid._update_feature_with_momentum(features)
    #         runner.model.module.roi_head.bbox_head.loss_reid._update_feature_crop_with_momentum(features_crop)
    ...
    def before_run(self, runner):
        ...
        with torch.no_grad():
            ...
            runner.model.module.roi_head.bbox_head.loss_reid._update_feature_crop(features_crop)
            runner.model.module.roi_head.bbox_head.loss_reid._init_ids(img_ids)
    ...
    def extract_features(self,
        ...
        for i in range(len(data_loader)):
            ...
            gt_features[gt_ids] = reid_gt_features
            img_ids[gt_ids] = gt_img_ids
            # print('=---------')
            # if i>10:
                # exit()
        ...
        return all_features, all_gt_features, img_ids
